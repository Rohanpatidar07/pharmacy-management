<?php
  ...
  if($role=='1')
   ...
   $sql2="select name,email from users where role='2'";
...
<div class="page-wrapper p-3">
    <div class="container-fluid bg-white p-5">
        <div class="row">
            <div class="col-lg-12">
                <h1 class='text-info'>Add distributor</h1>
                ...
                <form class="form-group" action="db.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <input type="submit" class="btn btn-info" name="sdi">
                        </div>
                    </div>
                ...
                if(!empty($em))
                {
                    $sql3="select*from adddistributor where email='$em'";
