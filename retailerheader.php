        ...
        <div class="sidenav">
            <div class="card">
                ...
                <div class="logo">
                    ...
                    <h1 class="logo-caption"><?php echo $name;?><br><span class="tweak">Re</span>tailer</h1>
                </div> <!-- logo class -->
                ...
                <div id="abhi" class="main-menu-item" onclick="showhide(this.id);">
                 ...
                 <div id="third" class="main-menu-item" onclick="showhide(this.id);">
                    <a href="#">
                    <i class="fa fa-medkit" aria-hidden="true"></i></i><span>Medicine</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
               ...
               <div id="abhii" class="main-menu-item" onclick="showhide(this.id);">
                    <a href="#">
                       <i class="fa fa-users" aria-hidden="true"></i><span>Wholesaler</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                ...
                <div id="abhiii" class="main-menu-item" onclick="showhide(this.id);">
                    <a href="#">
                    <i class="fa fa-user-secret" aria-hidden="true"></i><span>Customer</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu" style="display: none;">
                        <li class="treeview"><a href="db.php?acu">Add Custumer</a></li>
                        <li class="treeview"><a href="db.php?mcu">Manage Customer</a></li>
                    </ul>
                </div>
                <!-- Sale strat -->
                <div id="first" class="main-menu-item" onclick="showhide(this.id);">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        <li class="treeview"><a href="db.php?saler">New Sale</a></li>
