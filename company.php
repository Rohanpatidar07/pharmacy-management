    ...
    <body>
            ...
            <div class="card">
                ...
                <div class="logo">
                    ...
                    <h1 class="logo-caption"><?php echo $name;?><br><span class="tweak">Co</span>mpany</h1>
                </div> <!-- logo class -->
                ...
                <div id="third" class="main-menu-item" onclick="showhide(this.id);">
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        <li class="treeview"><a href="db.php?addmedicine">Add Medicine</a></li>
                        <li class="treeview"><a href="db.php?manage_medicine">Manage Medicine</a></li>
                ...
                <div id="second" class="main-menu-item" onclick="showhide(this.id);">
                    <a href="#">
                        <i class="fa fa-handshake"></i><span>distributors</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu" style="display: none;">
                        <li class="treeview"><a href="db.php?addd">Add distributors</a></li>
                        <li class="treeview"><a href="db.php?mdistributor">Manage distributors</a></li>
                    </ul>
                </div>
                <!-- distributor end -->
                <!-- recive order -->
