<?php
  ...
  if($role=='2')
   ...
   $sql2="select name,email from users where role='3'";
...
<div class="page-wrapper p-3">
    <div class="container-fluid bg-secondary text-white p-5">
        <div class="row">
            <div class="col-lg-12">
                <h1 class='text-info'>Add Wholesaler</h1>
                ...
                <form class="form-group" action="db.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <input type="submit" class="btn btn-info" name="swh">
                        </div>
                    </div>
                ...
                if(!empty($em))
                {
                    $sql3="select*from addwholesaler where email='$em'";
                ...
                ?>
                    <form class="form-group" action="db.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="wcname" class="form-control" readonly="readonly" value="<?php echo $wcn;?>">
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg-2">
                        ...
                        <hr>
                        <input type="submit" class="btn btn-info" name="addw" value="addw">
                    </form>
                    <?php } 
                    else
                    {
                ...
                <form class="form-group" action="db.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="wcname" class="form-control">
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-2">
