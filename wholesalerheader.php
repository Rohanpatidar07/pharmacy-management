        ...
        <div class="sidenav">
            <div class="card">
                ...
                <div class="logo">
                    ...
                    <h1 class="logo-caption"><?php echo $name;?><br><span class="tweak">Whole</span>saler</h1>
                </div> <!-- logo class -->
                <!-- dashboard start -->
                ...
                <div id="second" class="main-menu-item" onclick="showhide(this.id);">
                    <a href="#">
                        <i class="fa fa-handshake"></i><span>Distributor</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu" style="display: none;">
                        <li class="treeview"><a href="db.php?addd">Add Distributor</a></li>
                        <li class="treeview"><a href="db.php?mdistributor">Manage Distributor</a></li>
                    </ul>
                </div>
                <!-- distributor end -->
                <div id="abhii" class="main-menu-item" onclick="showhide(this.id);">
                    <a href="#">
                       <i class="fa fa-users" aria-hidden="true"></i><span>Retailer</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu" style="display: none;">
                        <li class="treeview"><a href="db.php?ar">Add Retailer</a></li>
                        <li class="treeview"><a href="db.php?mr">Manage Retailer</a></li>
                    </ul>
                </div>
                <!-- Sale strat -->
